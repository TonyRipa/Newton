...
*/
	...
	laplacetimes(other) {							//	+2024.8
		if (other.toString()=='1/10') return other.laplacetimes(this)
		if (other.toString()=='1/11') return other.laplacetimes(this)
		if (other.toString()=='1/100') return other.laplacetimes(this)
		if (this.toString()=='1/10') return other
		if (this.toString()=='1/11') return other.eval(this.reciprocal())
		if (this.toString()=='1/100') return new polynomialratio1().parse(math.simplify('-'+math.derivative(new polynomialratio1('s',other).toString(),'s').toString())).pv
	}
